    ...
    fun generateText(
        ...
        try {
            ...
            for (turn in history) {
                ...
                contentObj.put("role", turn.first) // "user" or "model"
                val parts = JSONArray()
            ...
            sysPartText.put("text", "คุณคือผู้ช่วยอัจฉริยะในที่ประชุม ตอบคำถามของผู้ใช้สั้นๆ กระชับ และตรงประเด็น เป็นภาษาไทย")
